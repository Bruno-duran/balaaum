...
bottomGround = createSprite(5,780);
...
gameOver = createSprite(770,400);
restart = createSprite(770,480);
...
function spawnObstaclesTop() 
{
  if(World.frameCount % 60 === 0) {
    obstacleTop = createSprite(1400,250,40,50);
...
{
      if(World.frameCount % 60 === 0) {
        obstacleBottom = createSprite(1400,650,40,50);
